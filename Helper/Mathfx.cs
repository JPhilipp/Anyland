...
// Amended. Via http://wiki.unity3d.com/index.php?title=Mathfx
...
public sealed class Mathfx
{
    ...
    {
        return new Vector2(EaseInOut(start.x,end.x, value), EaseInOut(start.y, end.y, value));
    }
 
    public static Vector3 EaseInOut(Vector3 start, Vector3 end, float value)
    {
        return new Vector3(EaseInOut(start.x, end.x, value), EaseInOut(start.y, end.y, value), EaseInOut(start.z, end.z, value));
    }
    ...
    {
        return new Vector2(EaseIn(start.x,end.x,value),EaseIn(start.y,end.y,value));
    }
 
    public static Vector3 EaseIn(Vector3 start, Vector3 end, float value)
    {
        return new Vector3(EaseIn(start.x, end.x, value), EaseIn(start.y, end.y, value), EaseIn(start.z, end.z, value));
    }
    ...
    {
        return new Vector3(
            LerpWithOvershoot(a.x, b.x, t),
            LerpWithOvershoot(a.y, b.y, t),
            LerpWithOvershoot(a.z, b.z, t)
        );
    }
